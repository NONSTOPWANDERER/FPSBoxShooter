...
void AShooterPlayerController::AddScore(int32 Amount)
{
    PlayerScore += Amount;
    UE_LOG(LogTemp, Warning, TEXT("Score is now: %d"), PlayerScore); // ✅ Check this prints
    ...
    {
        UE_LOG(LogTemp, Error, TEXT("BulletCounterUI is null!"));
    }
}